...
import { LayoutDashboard, Wallet, Users, User, Home as HomeIcon } from 'lucide-react'; // Added HomeIcon
import { cn } from '@/lib/utils';

const navItems = [
  { href: '/dashboard', label: 'Home', icon: HomeIcon }, // Changed label to 'Home', icon to HomeIcon
