  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className={cn(
        ...
        isPastAndMissed ? "bg-destructive border-destructive-foreground" : // Ensure contrast for X
...
export default function DailyStreakPage() {
  ...
  useEffect(() => {
    ...
    if (isAdModalOpen && !isAdWatchedInModal) {
      const totalSteps = AD_DURATION_SECONDS * 20; // e.g., 5s * 20 steps/sec = 100 steps
      const intervalDuration = 1000 / 20; // 50ms interval for 20 steps/sec
    ...
    <div className="space-y-6 pb-16">
      <div className="bg-primary text-primary-foreground p-6 rounded-b-xl shadow-lg">
        <div className="flex items-center mb-4">
          ...
          <h1 className="text-2xl font-bold text-center flex-1">Daily Streak</h1>
        </div>
